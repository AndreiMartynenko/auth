...
install-deps:
	...
	GOBIN=$(LOCAL_BIN) go install -mod=mod google.golang.org/cmd/protoc-gen-go-grpc@v1.2

get-deps:
	go get -u google.golang.org/protobuf/cmd/protoc-gen-go
	go get -u google.golang.org/cmd/protoc-gen-go-grpc
...
docker-build-and-push:
	...
	docker login -u token -p CRgAAAAAvGuTLkPqxHoCh-Upd6W4wG69EvvMjW6Y cr.selcloud.ru/andy
